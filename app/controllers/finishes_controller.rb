class FinishesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @finish.save
        format.html { redirect_to manage_finishes_path, notice: 'Finish was successfully created.' }
      else
  ...
  def update
    ...
    respond_to do |format|
      if @finish.update_attributes(params[:finish])
        format.html { redirect_to manage_finishes_path, notice: 'Finish was successfully updated.' }
      else
  ...
  def destroy
    ...
    redirect_to manage_finishes_path
  end
end